...
func DefaultDataDir() string {
	...
	case "darwin":
		...
		oldPath := filepath.Join(home, "Library", "VOCCHAIN")
		newPath := filepath.Join(home, "Library", "Application Support", "VOCCHAIN")
		...
		return newPath
	case "windows":
		return filepath.Join(home, "AppData", "Roaming", "VOCCHAIN")
	default:
		return filepath.Join(home, ".VOCCHAIN")
	}
}
