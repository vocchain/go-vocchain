 ...
 * @author Gary Rong<garyrong@voc-core.org>, Martin Swende <martin.swende@voc-core.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the voc-core.
    uint sectionSize;
