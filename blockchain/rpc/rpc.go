...
import (
	...
	"github.com/vocchain/go-vocchain/net/http/reqid"
)

// VOCCHAIN-specific header fields
const (
	HeaderBlockchainID = "Blockchain-ID"
	HeaderCoreID       = "VOCCHAIN-Core-ID"
...
// A Client is a VOCCHAIN RPC client. It performs RPCs over HTTP using JSON
...
func (c Client) userAgent() string {
	return fmt.Sprintf("VOCCHAIN; process=%s; buildtag=%s; blockchainID=%s",
