...
import (
	...
	"github.com/vocchain/go-vocchain/accesstoken"
	...
	"github.com/vocchain/go-vocchain/blockchain/txfeed"
	cfg "github.com/vocchain/go-vocchain/config"
	"github.com/vocchain/go-vocchain/consensus"
	"github.com/vocchain/go-vocchain/database"
	dbm "github.com/vocchain/go-vocchain/database/leveldb"
	"github.com/vocchain/go-vocchain/env"
	"github.com/vocchain/go-vocchain/event"
	VOCCHAINLog "github.com/vocchain/go-vocchain/log"
	"github.com/vocchain/go-vocchain/mining/cpuminer"
	"github.com/vocchain/go-vocchain/mining/miningpool"
	"github.com/vocchain/go-vocchain/mining/tensority"
	"github.com/vocchain/go-vocchain/net/websocket"
	"github.com/vocchain/go-vocchain/netsync"
	"github.com/vocchain/go-vocchain/p2p"
	"github.com/vocchain/go-vocchain/protocol"
	w "github.com/vocchain/go-vocchain/wallet"
)
...
func NewNode(config *cfg.Config) *Node {
	...
	if err := VOCCHAINLog.InitLogFile(config); err != nil {
	...
	if profileHost != "" {
		// Profiling VOCCHAINd programs.see (https://blog.golang.org/profiling-go-programs)
