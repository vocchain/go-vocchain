...
// VOCAssetID is VOC's asset id, the soul asset of VOCCHAIN
var VOCAssetID = &bc.AssetID{
...
// VOCDefinitionMap is the ....
var VOCDefinitionMap = map[string]interface{}{
	"name":        VOCAlias,
	"symbol":      VOCAlias,
	"decimals":    8,
	"description": `VOCCHAIN Official Issue`,
}
...
var MainNetParams = Params{
	...
	Bech32HRPSegwit: "bm",
	DefaultPort:     "46657",
	DNSSeeds:        []string{"www.mainnetseed.VOCCHAIN.io"},
	Checkpoints: []Checkpoint{
...
var TestNetParams = Params{
	...
	Bech32HRPSegwit: "tm",
	DefaultPort:     "46656",
	DNSSeeds:        []string{"www.testnetseed.VOCCHAIN.io"},
	Checkpoints: []Checkpoint{
