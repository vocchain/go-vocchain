...
import (
	...
	"github.com/vocchain/go-vocchain/node"
)
...
var runNodeCmd = &cobra.Command{
	Use:   "node",
	Short: "Run the VOCCHAINd",
	RunE:  runNode,
}

func init() {
	runNodeCmd.Flags().String("prof_laddr", config.ProfListenAddress, "Use http to profile VOCCHAINd programs")
