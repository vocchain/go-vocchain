...
// Package bind generates voc-core contract Go bindings.
//
// Detailed usage document and tutorial available on the go-voc-core Wiki page:
// https://github.com/voc-core/go-voc-core/wiki/Native-DApps:-Go-bindings-to-voc-core-contracts
package bind
