...
// stateObject represents an voc-core account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of voc-core address of the account
	data     Account
	db       *StateDB
...
// Account is the voc-core consensus representation of accounts.
