...
// StateDBs within the voc-core protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/voc-core/go-voc-core/pull/16485#issuecomment-380438527),
