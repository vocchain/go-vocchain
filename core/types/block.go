...
// Header represents a block header in the voc-core blockchain.
type Header struct {
...
// Block represents an entire block in the voc-core blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the voc-core
...
// EncodeRLP serializes b into the voc-core RLP block format.
