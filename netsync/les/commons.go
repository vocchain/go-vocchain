...
// NodeInfo represents a short summary of the voc-core sub-protocol metadata
// known about the host peer.
type NodeInfo struct {
	Network    uint64                   `json:"network"`    // voc-core network ID (1=Frontier, 2=Morden, Ropsten=3, Rinkeby=4)
