...
import (
	...
	"github.com/voc-core/go-voc-core/les/flowcontrol"
	"github.com/voc-core/go-voc-core/log"
	"github.com/voc-core/go-voc-core/node"
	"github.com/voc-core/go-voc-core/p2p/enode"
	"github.com/voc-core/go-voc-core/p2p/simulations"
	"github.com/voc-core/go-voc-core/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext) (node.Service, error) {
	...
	voc-core, err := eth.New(ctx.NodeContext, &config)
	if err != nil {
		return nil, err
	}
	server, err := NewLesServer(voc-core, &config)
	if err != nil {
		return nil, err
	}
	voc-core.AddLesServer(server)
	return voc-core, nil
}
