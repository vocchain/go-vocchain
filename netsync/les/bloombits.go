...
import (
	...
	"github.com/voc-core/go-voc-core/common/bitutil"
	"github.com/voc-core/go-voc-core/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an voc-core
...
func (eth *Lightvoc-core) startBloomHandlers(sectionSize uint64) {
